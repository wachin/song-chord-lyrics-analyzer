...
* **Status:** phase 0 complete — repository, CLI, canonical model, engine
  interfaces, audio metadata, tests and CI. No analysis engine is integrated
  yet; see the [roadmap](ROADMAP.md) for the development order.
